...
const animals = [
  ...
  },
  {
    ...
    image: "https://images.unsplash.com/photo-1611689342806-0863700ce1e4?w=600",
  },
  {
    id: 5,
    title: "🐆 Cheetah",
    ...
    image: "https://images.unsplash.com/photo-1526246708488-d433888791b7?w=600",
  },
  {
    id: 6,
    title: "🦓 Zebra",
    ...
    image: "https://images.unsplash.com/photo-1526095179574-86e545346ae6?w=600",
  },
];
...
function renderAnimalCard() {
  ...
  const allAnimalCard = animals
    .map((animal, index) => {
      const reverseClass = index % 2 !== 0 ? "reverse" : "";
      const cardHTML = `<div class="animal-card ${reverseClass}">
                <img
                                src="${animal.image}"
                                alt="${animal.title}"
                                />
    ...
    .join("");
  animalContainer.innerHTML = allAnimalCard;
}
renderAnimalCard();
